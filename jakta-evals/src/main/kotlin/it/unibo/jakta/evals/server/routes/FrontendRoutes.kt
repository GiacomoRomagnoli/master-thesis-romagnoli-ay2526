...
import it.unibo.jakta.evals.server.Utils.formatTimestamp
...
fun Application.uiRoutes(scheduler: ExperimentScheduler) =
    routing {
        get("/") {
            call.respondHtml {
                head {
                ...
                body {
                    ...
                    val experiments = scheduler.listExperiments()
                    ...
                    if (experiments.isEmpty()) {
                        ...
                        experiments.forEach { exp ->
                            div(classes = "experiment") {
                                ...
                                // Show runs table
                                val runs = scheduler.getExperimentRuns(exp.id)
                                if (runs.isNotEmpty()) {
                                    h3 { +"Runs:" }
